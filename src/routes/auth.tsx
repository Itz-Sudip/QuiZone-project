        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {mode === "signin"
                ? "Sign in to tailor study sets to your exam."
                : "Save your exam profile so notes get personalized."}
            </p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="mb-4 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-input bg-background px-4 py-2.5 text-sm font-medium transition hover:bg-accent disabled:opacity-60"
          >
